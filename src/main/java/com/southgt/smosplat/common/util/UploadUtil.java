...
//    private String imagePath = "/imageFile/" + new SimpleDateFormat("yyyyMMddHH").format(new Date()) + "";// 配置图片路径  
	private String imagePath = new SimpleDateFormat("yyyyMMddHH").format(new Date()) + "";// 配置图片路径  
     ...
     * @throws IOException 
     */  
    public void uploadImage1(HttpServletRequest request,MultipartFile file, String getUploadContentType, String getUploadFileName,String path) throws IOException  
    {  
...
//        String fileNewName = generateFileName(getUploadFileName);  
        String fileNewName =getUploadFileName.substring(0, getUploadFileName.lastIndexOf("."))+"_thumbnail."+"png";
