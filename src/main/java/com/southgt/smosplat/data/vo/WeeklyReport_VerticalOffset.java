 ...
 *
 */
public abstract class WeeklyReport_VerticalOffset {
	/**
	 * 点编号
	 */
	private String code;
	...
	public void setOriginalAveH(double originalAveH) {
		this.originalAveH = originalAveH;
	}
	public String getOriginalAveDate() {
		return originalAveDate;
	}
	public void setOriginalAveDate(String originalAveDate) {
		this.originalAveDate = originalAveDate;
	}
	@Override
	public String toString() {
		return "WeeklyReport_VerticalOffset [code=" + code + ", monVal=" + monVal + ", tueVal=" + tueVal + ", wedVal="
				...
				+ ", originalAveH=" + originalAveH + ", originalAveDate=" + originalAveDate + "]";
	}
}
