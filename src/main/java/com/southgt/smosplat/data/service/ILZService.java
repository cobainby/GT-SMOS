 ...
 *
 */
public interface ILZService extends IBaseService<LZ_Data>{
	/**
	 * 
	 * 检查水准数据
	 ...
	 *
	 */
	Map<String,Object> checkLZData(String jsonOriginalData, String sourceData) throws Exception;
	 ...
	 *
	 */
	void saveManualData(Project project, List<LZ_Data> data, List<String> gapRateEarlyWarningPoints, List<String> accumEarlyWarningPoints,byte flag)throws Exception;
