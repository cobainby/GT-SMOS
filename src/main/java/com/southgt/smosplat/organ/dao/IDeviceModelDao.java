 ...
 *
 */
public interface IDeviceModelDao extends IBaseDao<DeviceModel> {

	/**
	 * TODO(这里用一句话描述这个方法的作用) 
	 * @date  2017年5月6日 下午3:26:38
	 * @return DeviceModel
	 * @param devModelName
	 * @return
	 * @throws null
	 ...
	 *
	 */
	List<DeviceModel> getDeviceModelByDevType(String devTypeName);
