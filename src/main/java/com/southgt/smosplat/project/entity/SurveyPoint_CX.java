 ...
 * <p>-----------------------------------------------------------------</p>
 * <p>2017年5月6日     YANG       v1.0.0        create</p>
 *
 */
@Entity
@Table(name="survey_point_cx")
public class SurveyPoint_CX implements Serializable {
	...
	private String originalTotalValue;
	...
	public String getOriginalTotalValue() {
		return originalTotalValue;
	}

	public void setOriginalTotalValue(String originalTotalValue) {
	...
	public String toString() {
		return "SurveyPoint_CX [surveyPointUuid=" + surveyPointUuid + ", code=" + code + ", codeChar=" + codeChar
				+ ", createTime=" + createTime + ", deep=" + deep + ", originalTotalValue=" + originalTotalValue
				+ ", warning=" + warning + ", monitorItem=" + monitorItem + ", project=" + project
				+ ", processedDataUuid=" + processedDataUuid + ", totalSurveyOrders=" + totalSurveyOrders + "]";
	}
