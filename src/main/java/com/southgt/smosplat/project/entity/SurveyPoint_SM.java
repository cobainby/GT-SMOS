 ...
 */
@Entity
@Table(name="survey_point_sm")
public class SurveyPoint_SM implements Serializable{
	...
	public String toString() {
		return "SurveyPoint_SM [surveyPointUuid=" + surveyPointUuid + ", code=" + code + ", codeChar=" + codeChar
				+ ", createTime=" + createTime + ", originalTotalValue=" + originalTotalValue + ", deviceType="
				+ deviceType + ", warning=" + warning + ", monitorItem=" + monitorItem + ", project=" + project
