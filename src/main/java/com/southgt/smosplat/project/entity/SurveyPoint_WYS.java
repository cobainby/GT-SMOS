 ...
 */
@Entity
@Table(name="survey_point_wys")
public class SurveyPoint_WYS implements Serializable {
	 ...
	 */
	@Column(name="processed_data_uuid",length=50)
	...
	public String toString() {
		return "SurveyPoint_WYS [surveyPointUuid=" + surveyPointUuid + ", code=" + code + ", codeChar=" + codeChar
				+ ", createTime=" + createTime + ", originalTotalValue=" + originalTotalValue + ", processedDataUuid="
				+ processedDataUuid + ", section=" + section + ", warning=" + warning + ", monitorItem=" + monitorItem
				+ ", project=" + project + "]";
	}
