 ...
 */
@Entity
@Table(name="survey_point_lz")
public class SurveyPoint_LZ implements Serializable {
	...
	public String toString() {
		return "SurveyPoint_LZ [surveyPointUuid=" + surveyPointUuid + ", code=" + code + ", codeChar=" + codeChar
